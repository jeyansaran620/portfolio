...
const Home = () => {
  return (
    <section id="home" className="min-h-screen flex flex-col justify-center px-8 lg:px-24 py-24 sm:py-32 bg-[#0a192f]">
      <div className="max-w-4xl">
        <p className="font-mono text-2xl text-teal-400 mb-6">Hi, my name is</p>

        <FadeInSection delay={500}>
          <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold text-gray-200 tracking-tight">
            Jeyan Karthikeyan.
          </h1>
        </FadeInSection>
        ...
        <FadeInSection delay={600}>
          <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold text-gray-400 mt-2 sm:mt-4 tracking-tight">
            I craft scalable digital solutions.
          </h2>
        </FadeInSection>
        ...
        <FadeInSection delay={700}>
          <p className="text-gray-400 mt-8 max-w-3xl text-lg leading-relaxed">
            ...
            that solve complex business challenges. Currently at <span className="text-teal-400">Walmart</span> as
            a Software Development Engineer, where I develop high-performance backend services and
